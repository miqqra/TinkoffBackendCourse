...
public class Chat extends TableImpl<ChatRecord> {
    ...
    /**
     * The column <code>CHAT.TGCHATID</code>.
     */
    public final TableField<ChatRecord, Long> TGCHATID = createField(DSL.name("TGCHATID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>CHAT.TRACKEDLINK</code>.
     */
    public final TableField<ChatRecord, Long> TRACKEDLINK = createField(DSL.name("TRACKEDLINK"), SQLDataType.BIGINT, this, "");
