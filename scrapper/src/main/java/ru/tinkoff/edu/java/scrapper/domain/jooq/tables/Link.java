...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_UPDATED = createField(DSL.name("LAST_UPDATED"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>LINK.LAST_CHECKED</code>.
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_CHECKED = createField(DSL.name("LAST_CHECKED"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>LINK.LAST_CHECKED_WHEN_WAS_UPDATED</code>.
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_CHECKED_WHEN_WAS_UPDATED = createField(DSL.name("LAST_CHECKED_WHEN_WAS_UPDATED"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>LINK.LAST_COMMIT_DATE</code>.
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_COMMIT_DATE = createField(DSL.name("LAST_COMMIT_DATE"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>LINK.LAST_ANSWER_DATE</code>.
     */
    public final TableField<LinkRecord, LocalDateTime> LAST_ANSWER_DATE = createField(DSL.name("LAST_ANSWER_DATE"), SQLDataType.LOCALDATETIME(6), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super Long, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function7<? super Long, ? super String, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? super LocalDateTime, ? extends U> from) {
